    ...
    <div className="page">
      <header className="header">
        <div className="container headerInner">
          <a href="#inicio" className="brand" aria-label="Voltar ao início">
            <img src={assetPath("logo-renovera.png")} alt="Renovera" width="168" height="40" />
          </a>
          ...
          <a className="headerButton" href={whatsappLink} target="_blank" rel="noopener noreferrer">
            Solicitar estudo
          </a>
        </div>
      </header>
      ...
      <main>
          ...
          <div className="container heroGrid">
            <div className="heroContent">
              ...
              <div className="heroActions">
                ...
                <a className="secondaryButton" href={whatsappLink} target="_blank" rel="noopener noreferrer">
        ...
        <section className="finalCta" aria-labelledby="cta-title">
          <div className="container finalCtaBox">
            <h2 id="cta-title">Quer transformar a simulação em um estudo real?</h2>
            <p>
            ...
            <a className="primaryButton" href={whatsappLink} target="_blank" rel="noopener noreferrer">
      ...
      <footer className="footer">
        <div className="container footerGrid">
          <div>
            <img src={assetPath("logo-renovera.png")} alt="Renovera" width="168" height="40" loading="lazy" />
            <p>
...
function Faq({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className={`faqItem ${open ? "active" : ""}`}>
      <button onClick={() => setOpen(!open)} aria-expanded={open} aria-controls={answerId}>
        <span>{question}</span>
        <strong>{open ? "−" : "+"}</strong>
      </button>

      {open && <p id={answerId}>{answer}</p>}
    </div>
  );
}
