...
const whatsappPhone = "5500000000000";
const whatsappText =
...
const logoUrl = `${import.meta.env.BASE_URL}logo-renovera.png`;
...
const sectors = [
  {
    title: "Geradores e Desenvolvedores de Projetos",
    text: "Revisão de pareceres, inversão de fluxo, ponto de conexão, fila de acesso e exigências técnicas da distribuidora."
  },
  {
    title: "Hospitais, Clínicas e Casas de Saúde",
    text: "Segurança operacional para unidades críticas, com análise de contratos, estabilidade elétrica e continuidade de fornecimento."
  },
  {
    title: "Indústrias e Plantas de Grande Porte",
    text: "Mitigação de multas, demanda contratada, obras impostas, restrições de conexão e riscos em infraestrutura elétrica."
  },
  {
    title: "Fundos de Investimento e Operadores de Ativos",
    text: "Due diligence regulatória antes de aporte, aquisição, expansão, retrofit ou estruturação de ativos de energia."
  }
];

const restrictionOptions = [
  "Inversão de Fluxo",
  "Reprovação de Padrão",
    ...
    <div className="page">
      <header className="header">
        <div className="container headerInner">
          <a href="#inicio" className="brand" aria-label="Renovera Consultoria Regulatória">
            <img src={logoUrl} alt="Renovera" width="168" height="51" />
        ...
        <section className="hero" id="inicio">
          ...
          <div className="container heroGrid">
            <div className="heroContent">
              ...
              <div className="heroStats" aria-label="Bases técnicas da atuação">
                <div>
        ...
        <section className="screening" id="triagem">
          <div className="container screeningGrid">
            <div className="screeningIntro">
              ...
              <p>
                Informe os dados básicos do caso. A ferramenta gera um diagnóstico preliminar local e orienta o próximo
                contato com a equipe Renovera.
              </p>

              <div className="diagnosticCard" aria-live="polite">
                <div className="scoreCircle" aria-label={`Potencial de contestação ${diagnostic.score} de 100`}>
            ...
            <form className="leadForm" onSubmit={handleSubmit}>
              <div className="formGrid">
                ...
                <label>
                  Potência / demanda do ativo em kW
                  <input
                    type="number"
                    min="0"
                    max="100000"
              ...
              <button className="formButton" type="submit">Gerar orientação preliminar</button>
              <a className="whatsButton" href={whatsappLink} target="_blank" rel="noopener noreferrer">
                Enviar caso pelo WhatsApp
              </a>

              {submitted && (
                <div className="successBox" role="status">
                  <strong>Diagnóstico preliminar gerado.</strong>
                  <p>
                    Esta versão ainda não envia dados para um servidor. Para atendimento, use o WhatsApp ou conecte o
                    formulário a um CRM, n8n, Make ou Google Sheets.
                  </p>
                </div>
              )}
            </form>
          ...
          <div className="container sectorsShell">
            ...
            <div className="sectorGrid">
              {sectors.map((sector, index) => (
                <article className="sectorCard" key={sector.title}>
                  <span>0{index + 1}</span>
                  <h3>{sector.title}</h3>
                  <p>{sector.text}</p>
                </article>
        ...
        <section className="finalCta">
          <div className="container finalCtaBox">
            ...
            <div className="finalCtaActions">
              ...
              <a className="secondaryButton" href={whatsappLink} target="_blank" rel="noopener noreferrer">Falar com especialista</a>
            </div>
          </div>
        </section>
      </main>
      ...
      <footer className="footer">
        <div className="container footerGrid">
          ...
          <div className="footerCol">
            <h4>Contato</h4>
            <a href={whatsappLink} target="_blank" rel="noopener noreferrer">WhatsApp comercial</a>
            <a href="mailto:contato@renovera.com.br">contato@renovera.com.br</a>
            <address>R. Visc. de Rio Branco, 106, São João da Boa Vista - SP</address>
          </div>
      ...
      <a className="whatsappFloat" href={whatsappLink} target="_blank" rel="noopener noreferrer" aria-label="Falar com a Renovera no WhatsApp">
        <WhatsAppIcon />
      </a>
